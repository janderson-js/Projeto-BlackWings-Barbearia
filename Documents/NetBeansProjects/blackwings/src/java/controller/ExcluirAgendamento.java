...
public class ExcluirAgendamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirAgendamento</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                AtendimentoDAO cDAO = new AtendimentoDAO();
                cDAO.excluirAtendimento(id);
                ...
                out.print("Erro excluir Agendamento: "+e);
            }
            out.println("</body>");
            out.println("</html>");
        }
