<%-- 
    ...
    Created on : 31/05/2021, 22:34:30
    Author     : Janderson
--%>
        ...
        <main>
            <div class="cont-cadastrar" id="altura">
                <div class="cadastro">
                    ...
                    <form name="inserir_menu" method="post" action="inserir_menu.do">
                        <table id="table-cadastro">
                            <tr>
                                <td><span>Titulo do Menu :</span></td>
                                <td><label><input type="text" placeholder="Ex: Venda" name="nome" required></label></td>
                            </tr>
                            <tr>
                                <td><span>Link do Menu :</span> </td>
                                <td><label><input type="text" placeholder="Ex: venda.com" name="link" required></label></td>
                            </tr>
                        </table>
