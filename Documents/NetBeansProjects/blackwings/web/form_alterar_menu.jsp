<%-- 
    ...
    Created on : 31/05/2021, 22:55:25
    Author     : Janderson
--%>
                ...
                <div class="cadastro">
                    ...
                    <%            Menu m = new Menu();
                        try {
                            ...
                            out.print("Erro Form alterar Menu: " + e);
                        }
                    %>
                    <form name="alterar_menu" method="post" action="alterar_menu.do">
                        <table id="table-cadastro" >
                            ...
                            <tr>
                                <td><span>Nome do Menu :</span></td>
                                <td><label><input type="text" name="nome" required value="<%=m.getNome()%>"></label></td>
                            </tr>
                            <tr>
                                <td><span>Link do Menu : </span></td>
                                <td><label><input type="text" name="link" required value="<%=m.getLink()%>"></label></td>
                            </tr>
                        </table>
